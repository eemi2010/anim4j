package com.eemi.anim4j.tweenlite.client;

import com.eemi.anim4j.core.client.Animation;
import com.eemi.anim4j.core.client.Function;
import com.eemi.anim4j.core.client.TweenLiteConfig;
...
public class TweenLite extends Animation {
    ...
    public native TweenLite to(Element target, double duration, TweenLiteConfig config)/*-{
		...
		return @com.eemi.anim4j.tweenlite.client.TweenLite::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
