package com.ait.anim4j.tweenmax.client;

import com.ait.anim4j.core.client.Animation;
import com.ait.anim4j.core.client.Function;
import com.ait.anim4j.core.client.TweenMaxConfig;
...
public class TweenMax extends Animation {
    ...
    public native TweenMax to(Element target, double duration, TweenMaxConfig config)/*-{
		...
		return @com.ait.anim4j.tweenmax.client.TweenMax::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
